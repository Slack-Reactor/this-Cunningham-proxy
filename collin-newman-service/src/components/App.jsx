...
class App extends React.Component {
  ...
  getData() {
    ...
    // axios.get('http://3.17.61.21:3004/api/reviews/')
    axios.get('http://localhost/api/reviews/')
      .then((res) => {
  ...
  helpfulClickHandler(e) {
    ...
    // axios.patch(`http://3.17.61.21:3004/api/reviews/${id}`)
    axios.patch(`http://localhost/api/reviews/${id}`)
      .then(() => {
        this.getData();
      })
      .catch((err) => console.log(err));
  ...
  writeReview() {
    ...
    review.images = [];
    axios.post('http://localhost/api/reviews', review)
      .then((res) => {
        console.log(res);
        this.getData();
      })
